...
class Dataset_generation(Dataset):
    ...
    def load_npy(self):
        self.x_train = np.load("x_train_523.npy").reshape(-1, 51, 3)
        self.x_valid = np.load("x_valid_523.npy").reshape(-1, 51, 3)
        self.x_test = np.load("x_test_523.npy").reshape(-1, 51, 3)
