...
class Dataset_generation(Dataset):
    ...
    def load_npy(self):
        self.x_train = np.load(self.path + "x_train_811.npy").reshape(-1,51)
        self.x_valid = np.load(self.path + "x_valid_811.npy").reshape(-1,51)
        self.x_test = np.load(self.path + "x_test_811.npy").reshape(-1,51)
        self.y_train = np.load(self.path + "y_train_811.npy").reshape(-1,51)
        self.y_valid = np.load(self.path + "y_valid_811.npy").reshape(-1,51)
        self.y_test = np.load(self.path + "y_test_811.npy").reshape(-1,51)
...
class Exp():
    def __init__(self,  patience):
        ...
        self.checkpoints_path = './checkpoint/NCM811/'
