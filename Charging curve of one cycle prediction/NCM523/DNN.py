...
class Dataset_generation(Dataset):
    ...
    def load_npy(self):
        self.x_train = np.load(self.path + "x_train_523.npy").reshape(-1,51)
        self.x_valid = np.load(self.path + "x_valid_523.npy").reshape(-1,51)
        self.x_test = np.load(self.path + "x_test_523.npy").reshape(-1,51)
        self.y_train = np.load(self.path + "y_train_523.npy").reshape(-1,51)
        self.y_valid = np.load(self.path + "y_valid_523.npy").reshape(-1,51)
        self.y_test = np.load(self.path + "y_test_523.npy").reshape(-1,51)
